...
import { usePermissions, useGlobalKeyboardShortcuts } from './hooks';
import {
  Sidebar,
  Header,
  ErrorBoundary,
...
import { initStores, useWebSocketStore } from './stores';
...
/**
 * 登录后默认落地页：班主任（class.view）→ 工作台总览；否则 → 数据看板。
 * 原默认路由固定渲染 Dashboard（需 score.view），班主任无该权限会落到"权限不足"页。
 */
...
const TeacherComments = createLazyComponent(() => import('./pages/TeacherComments'));
const WorkbenchOverview = createLazyComponent(() => import('./pages/WorkbenchOverview'));
              ...
              <Routes>
                ...
                >
                  ...
                  <Route
                    path='study-groups'
                    element={
                      <PermissionGuard requiredPermission='study_group.view'>
                        <StudyGroups />
                      </PermissionGuard>
                    }
                  />
                  <Route
                    path='mental-health'
                    element={
                      <PermissionGuard requiredPermission='mental_health.view'>
                        <MentalHealth />
                      </PermissionGuard>
                    }
                  />
                  ...
                  <Route
                    path='activity'
                    element={
                      <PermissionGuard requiredPermission='activity.view'>
                        <ActivityManage />
                      </PermissionGuard>
                    }
                  />
                  <Route
                    path='culture'
                    element={
                      <PermissionGuard requiredPermission='culture.view'>
                        <CultureBoard />
                      </PermissionGuard>
                    }
                  />
                  <Route
                    path='study-guide'
                    element={
                      <PermissionGuard requiredPermission='study_guide.view'>
                        <StudyGuide />
                      </PermissionGuard>
                    }
                  />
                  <Route
                    ...
                    element={
                      <PermissionGuard requiredPermission='comment.view'>
                        <TeacherComments />
                      </PermissionGuard>
                    }
                  />
