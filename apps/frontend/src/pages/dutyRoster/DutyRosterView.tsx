...
import { DutyGroup, DutyAssignment } from '../../types';
import {
  CurrentClassLabel,
  WorkbenchBreadcrumb,
  EmptyState,
...
export const defaultDutyForm: DutyFormData = {
  name: '',
...
export const defaultAssignmentForm: AssignmentFormData = {
  group_id: 0,
  student_id: 0,
...
interface DutyRosterViewProps {
  ...
  dutyForm: DutyFormData;
  setDutyForm: Dispatch<SetStateAction<DutyFormData>>;
  assignmentForm: AssignmentFormData;
  setAssignmentForm: Dispatch<SetStateAction<AssignmentFormData>>;
  groupPage: number;
  ...
  handleAssignDuty: () => Promise<void>;
  handleMarkComplete: (assignmentId: number) => Promise<void>;
