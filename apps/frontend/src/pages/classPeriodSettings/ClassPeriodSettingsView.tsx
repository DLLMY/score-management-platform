...
import type { ClassPeriodSettingsViewProps } from './types';
...
export default function ClassPeriodSettingsView({
  periods,
  hasChanges,
  showModal,
  editingPeriod,
                  ...
                  >
                    ...
                    <div className='text-center shrink-0'>
                      <div className='flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-slate-700 px-3 py-1.5 rounded-lg'>
                        ...
                        {formatHourMinute(period.start_hour, period.start_minute)} -{' '}
                        {formatHourMinute(period.end_hour, period.end_minute)}
                      </div>
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      setFormData({ period_number: parseInt(e.target.value) || 1 })
                    }
                    className='w-full px-4 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-colors'
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      setFormData({ sort_order: parseInt(e.target.value) || 0 })
                    }
                    className='w-full px-4 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-colors'
                  />
                </div>
                  ...
                  <div className='flex items-center gap-2'>
                    <select
                      ...
                      onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                        setFormData({ start_hour: parseInt(e.target.value) })
                      }
                    ...
                    <select
                      ...
                      onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                        setFormData({ start_minute: parseInt(e.target.value) })
                      }
                      className='flex-1 px-3 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-colors'
                    >
                      {minuteOptions.map((m) => (
                ...
                <div>
                  ...
                  <div className='flex items-center gap-2'>
                    <select
                      ...
                      onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                        setFormData({ end_hour: parseInt(e.target.value) })
                      }
                      className='flex-1 px-3 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-colors'
                    >
                      {Array.from({ length: 24 }, (_, i) => (
                    ...
                    <select
                      ...
                      onChange={(e: ChangeEvent<HTMLSelectElement>) =>
                        setFormData({ end_minute: parseInt(e.target.value) })
                      }
                      className='flex-1 px-3 py-2.5 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:bg-slate-700 dark:text-white transition-colors'
                    >
                      {minuteOptions.map((m) => (
