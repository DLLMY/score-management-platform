...
const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <div className='max-w-4xl mx-auto'>
      ...
      <Modal isOpen={showEditModal} onClose={onCloseEdit} title='编辑个人资料'>
        <form
        ...
        >
          <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            <div>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  onEditFormChange('real_name', e.target.value)
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  onEditFormChange('phone', e.target.value)
                }
                className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500'
              />
            </div>
            <div className='md:col-span-2'>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  onEditFormChange('class_name', e.target.value)
                }
                className='w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500'
              />
            </div>
          ...
          <div className='flex gap-3 pt-4 border-t border-gray-100'>
            {/* S1: 本人资料编辑，无需权限门控 */}
            <Button variant='outline' onClick={onCloseEdit} disabled={saving}>
              取消
            </Button>
      ...
      <Modal isOpen={showPasswordModal} onClose={onClosePassword} title='修改密码'>
        <form
          onSubmit={(e: FormEvent<HTMLFormElement>) => {
            e.preventDefault();
            onSavePassword();
        ...
        >
          ...
          <div className='flex gap-3 pt-4 border-t border-gray-100'>
            ...
            <Button variant='outline' onClick={onClosePassword} disabled={saving}>
              取消
            </Button>
            <Button type='submit' disabled={saving}>
              {saving ? (
