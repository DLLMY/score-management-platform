...
permissions = [
    ...
    ("comment.view", "查看评语", "classroom", "查看班主任评语"),
    ("comment.edit", "编辑评语", "classroom", "编辑班主任评语"),
...
roles = [
    ...
    (
        ...
        "班主任",
        "管理班级事务",
        "student.view,student.edit,score.view,score.entry,class.view,class.edit,exam.view,rule.view,notification.view,notification.send,phonebox.unlock.manage,homework.view,homework.edit,homework.check,attendance.view,attendance.edit,attendance.approve,mental_health.view,mental_health.edit,activity.view,activity.edit,culture.view,culture.edit,study_group.view,study_group.edit,study_guide.view,study_guide.edit,comment.view,comment.edit",
        1,
    ),
    (
        "subject_teacher",
