...
# 清理旧数据
for t in ['role_hierarchies', 'admin_roles', 'role_permission_mappings', 'role_permission', 'permissions']:
...
roles = [
    ...
    ('admin', '管理员', '普通管理员权限', 'system.settings,system.users,system.roles,system.logs,system.backup,system.cache,system.monitor,device.view,device.create,device.edit,device.delete,device.groups,student.view,student.create,student.edit,student.delete,score.view,score.entry,score.edit,score.delete,score.approve,class.view,class.manage,exam.view,exam.manage,rule.view,rule.manage,notification.view,notification.send,algorithm.view,algorithm.manage,report.export,report.import,data.view,data.export,data.import,data_analysis', 1),
    # class.edit 必须有：座次表/值日生/班委/家长联系 4 个模块的写端点全靠它把关
    ('teacher', '班主任', '管理班级事务', 'student.view,student.edit,score.view,score.entry,class.view,class.edit,exam.view,rule.view,notification.view,notification.send,phonebox.unlock.manage,homework.view,homework.edit,homework.check,attendance.view,attendance.edit,attendance.approve,mental_health.view,mental_health.edit,activity.view,activity.edit,culture.view,culture.edit,study_group.view,study_group.edit,study_guide.view,study_guide.edit', 1),
    ('subject_teacher', '任课教师', '查看授课班级', 'student.view,score.view,score.entry,class.view,exam.view,notification.view,data.view', 1),
    ('head_teacher', '年级组长', '管理年级事务', 'student.view,student.edit,score.view,score.entry,score.approve,class.view,class.manage,exam.view,exam.manage,rule.view,notification.view,notification.send,homework.view,attendance.view,attendance.approve,mental_health.view,activity.view,study_group.view,data.view,data.export,report.export,timetable.rule.manage', 1),
    ('dashboard_viewer', '数据大屏', '数据展示', 'data.view,data_analysis,algorithm.view,report.export,device.view,student.view,score.view,class.view', 1),
    ('operator', '运维人员', '设备运维', 'device.view,device.edit,device.groups,system.logs,system.monitor,notification.view', 1),
    ('viewer', '查看者', '仅查看', 'device.view,student.view,score.view,class.view,exam.view,rule.view,notification.view,data.view,algorithm.view', 1),
]
...
# 分配角色给现有管理员
cur.execute('INSERT OR IGNORE INTO admin_roles (admin_id, role_code, assigned_at) VALUES (1,"super_admin",datetime("now"))')
cur.execute('INSERT OR IGNORE INTO admin_roles (admin_id, role_code, assigned_at) VALUES (2,"teacher",datetime("now"))')
conn.commit()
