...
from models import db, Admin, AdminClass, ClassInfo, cascade_delete_related_records
...
class AdminResource(Resource):
    ...
    def delete(self, id):
        ...
        """
        admin = Admin.query.get_or_404(id)
        # 先清理引用该管理员的子表记录（可空外键仅解除引用，不删业务数据）
    ...
    def post(self):
        ...
        if admin and verify_password(password, admin.password):
            ...
            return {
                ...
                "message": "登录成功",
                **tokens,
                "admin": {"id": admin.id, "username": admin.username, "role": admin.role, "real_name": admin.real_name},
            }
...
class AdminAssignClass(Resource):
    ...
    def post(self, admin_id):
        ...
        _class_info = ClassInfo.query.get_or_404(class_id)  # noqa: F841
