...
notification_model = ns_notifications.model('Notification', {
...
class NotificationList(Resource):
    ...
    def post(self):
        ...
        db.session.commit()
        return {'success': True, 'message': '通知创建成功', 'notification_id': notification.id}, 201
...
class NotificationResource(Resource):
    ...
    def put(self, id):
        ...
        db.session.commit()
        return {'success': True, 'message': '通知更新成功'}
...
class NotificationSend(Resource):
    ...
    def post(self):
        ...
        return {'success': True, 'message': '通知发送成功', 'notification_id': notification.id}
