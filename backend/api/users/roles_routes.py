...
role_list_response = ns_roles.model(
    "RoleListResponse", {"roles": fields.List(fields.Nested(role_model), description="角色列表")}
)
...
class RoleList(Resource):
    ...
    def get(self):
        ...
        return {"roles": [{"id": r.id, "name": r.name, "permissions": r.permissions} for r in roles]}
