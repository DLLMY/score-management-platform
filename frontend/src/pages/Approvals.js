                  ...
                  <div className="flex-1">
                    ...
                    {approval.score_change !== null && approval.score_change !== undefined && (
                      <p className="text-sm font-medium mb-2">
                        积分变化: <span className={approval.score_change >= 0 ? 'text-green-600' : 'text-red-600'}>
                          {approval.score_change >= 0 ? '+' : ''}{approval.score_change}
                        </span>
                      </p>
                    )}
        ...
        <form onSubmit={handleCreateApproval} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setCreateForm({ ...createForm, score_change: parseInt(e.target.value) || 0 })}
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900">{selectedApproval.user_name || `用户 ${selectedApproval.user_id}`}</p>
              </div>
            </div>
              ...
              <div>
                ...
                <p className="text-xl font-bold mt-1">
                  <span className={selectedApproval.score_change >= 0 ? 'text-green-600' : 'text-red-600'}>
                    {selectedApproval.score_change >= 0 ? '+' : ''}{selectedApproval.score_change}
                  </span>
                </p>
              </div>
            )}
