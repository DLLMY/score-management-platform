...
const SearchEmptyState = memo(({ searchTerm = '', onClearSearch = null, className = '' }) => {
  return (
    <div
      className={`flex flex-col items-center justify-center py-16 px-6 text-center ${className}`}
    >
...
const ErrorState = memo(({ message = '加载失败', onRetry = null, className = '' }) => {
  return (
    <div
      className={`flex flex-col items-center justify-center py-16 px-6 text-center ${className}`}
    >
...
export { EmptyState, SearchEmptyState, ErrorState };
