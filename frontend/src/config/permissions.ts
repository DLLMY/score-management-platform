...
export const PERMISSIONS: PermissionDefinition[] = [
  ...
  {
    code: 'ops_center.view',
    name: '运维中心查看',
    description: '查看系统运维中心聚合仪表盘',
    category: '系统管理',
  },
  ...
  {
    code: 'phonebox.unlock.manage',
    name: '手机箱开箱策略',
    description: '管理手机箱开箱策略与放行',
    category: '设备管理',
  },
  ...
  // 数据分析
  {
    code: 'algorithm.view',
    name: '查看算法',
    description: '查看算法分析结果',
    category: '数据分析',
  },
  {
    code: 'algorithm.manage',
    name: '管理分析',
    description: '管理算法分析参数与任务',
    category: '数据分析',
  },
  ...
  {
    code: 'notification.force_send',
    name: '强制下发',
    description: '远程强制下发通知（含紧急广播）',
    category: '通知中心',
  },
  ...
  // 班主任工作台 - 心理健康
  {
    code: 'mental_health.view',
    name: '查看心理健康',
    description: '查看心理健康记录',
    category: '班主任工作台',
  },
  {
    code: 'mental_health.edit',
    name: '编辑心理健康',
    description: '编辑心理健康记录',
    category: '班主任工作台',
  },
  ...
  // 班主任工作台 - 班级文化
  {
    code: 'culture.view',
    name: '查看班级文化',
    description: '查看班级文化记录',
    category: '班主任工作台',
  },
  {
    code: 'culture.edit',
    name: '编辑班级文化',
    description: '编辑班级文化记录',
    category: '班主任工作台',
  },

  // 班主任工作台 - 学习小组
  {
    code: 'study_group.view',
    name: '查看学习小组',
    description: '查看学习小组',
    category: '班主任工作台',
  },
  {
    code: 'study_group.edit',
    name: '编辑学习小组',
    description: '编辑学习小组',
    category: '班主任工作台',
  },
  ...
  // 班主任工作台 - 学法指导
  {
    code: 'study_guide.view',
    name: '查看学法指导',
    description: '查看学法指导',
    category: '班主任工作台',
  },
  {
    code: 'study_guide.edit',
    name: '编辑学法指导',
    description: '编辑学法指导',
    category: '班主任工作台',
  },
...
export const PERMISSION_MAP: Record<string, PermissionDefinition> = PERMISSIONS.reduce(
  (acc, perm) => ({ ...acc, [perm.code]: perm }),
  {}
);
...
export const DEFAULT_PERMISSIONS_FOR_ADMIN: string[] = ['all'];
